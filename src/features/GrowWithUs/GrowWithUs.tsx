	...
	<div className={`${customStyle}`}>
		<div className={`${styles.container}`}>
			...
			<div className='flex flex-wrap justify-between items-stretch gap-x-3 gap-y-2 sm:flex-col md:flex-row'>
				...
				<div className={`sm:order-5 md:-order-none rounded-2xl border-2 border-darkBgSecondary black-40 sm:p-7 lg:p-10 flex flex-col justify-center items-center gap-y-4 sm:w-full md:w-1/2-custom md:h-96`}>
