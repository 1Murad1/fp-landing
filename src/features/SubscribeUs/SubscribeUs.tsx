...
export const SubscribeUs: FC<SubscribeUsProps> = React.memo(({ customStyle }) => (
	<div className={`${customStyle}`}>
		<div className={`${styles.container}`}>
			<h3 data-aos="fade-right" data-aos-delay="1000" className={`${styles.titleH3} mb-1`}>Subscribe us</h3>
			<p data-aos="fade-right" data-aos-delay="1100" className={`${styles.baseText} text-darkTextMuted mb-10`}>And always stay up to date with the latest news</p>
