...
export const BrowseOurLatestNews: FC<IBrowseOurLatestNewsProps> = React.memo(({ customStyle }) => (
	<div className={`${customStyle}`}>
		<div className={`${styles.container}`}>
			<h3 className={`${styles.titleH3} mb-4`}>Browse our latest news</h3>
			<div className='flex items-start justify-between gap-x-3 sm:mb-7 lg:mb-10'>
				<p className={`${styles.baseText} text-darkTextMuted max-w-5xl w-full`}>Dive deep into our collection of articles, stories, and updates on all things Grass. Whether you’re looking for industry trends, company updates, or behind-the-scenes glimpses, our blog offers a wealth of knowledge to feed your curiosity.</p>
